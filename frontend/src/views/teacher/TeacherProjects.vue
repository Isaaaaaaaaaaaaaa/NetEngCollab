      ...
      <el-col :xs="24" :lg="7">
        <el-card class="app-card" shadow="never">
          ...
          <template v-else>
            ...
            <el-timeline v-else style="margin-bottom: 8px;">
              <el-timeline-item
              ...
              >
                <div style="display:flex; align-items:center; justify-content:space-between; gap:8px;">
                  <div style="display:flex; flex-direction:column; gap:2px; max-width:160px;">
            ...
            <template v-else>
              ...
              <el-scrollbar v-else style="max-height: 220px;">
                <ul style="list-style:none; padding:0; margin:0; font-size:12px; color:var(--app-text);">
                  ...
                  >
                    <div style="margin-bottom:2px;">{{ u.content }}</div>
